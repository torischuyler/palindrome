require_relative 'lib/torischuyler_palindrome/version'

Gem::Specification.new do |spec|
  spec.name          = "torischuyler_palindrome"
  spec.version       = TorischuylerPalindrome::VERSION
  spec.authors       = ["torischuyler"]
  spec.email         = ["schuylervictoria@gmail.com"]
